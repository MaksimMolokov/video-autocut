...
# --- Анализ: параллелизм ---
ANALYSIS_WORKERS = 4           # сцен одновременно на этапе «качество + превью»
                               # (каждая сцена — свои ffmpeg-процессы)

# --- Рендер ---
HW_ENCODE = True               # h264_videotoolbox, если ffmpeg его поддерживает
                               # (Apple Silicon; выкл — везде libx264)
